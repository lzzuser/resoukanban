...
![看板预览](./images/preview.jpg)   <!-- 你可以替换为实际预览图 -->
...
<!-- 示例图片（请替换为你的实际截图） -->
![知乎热榜](./images/zhihu.jpg)  
![日历](./images/calendar.jpg)  
![天气看板](./images/weather.jpg)
...
- 每日一言： [hitokoto.cn](https://hitokoto.cn)
- 知乎热榜：知乎官方 API
